      ...
      <div className="masterCraft w-[90vw] md:w-[60vw] lg:w-[50vw] m-auto relative pt-60">
        ...
        <div className="range w-full bg-white py-6 md:pl-8 xl:pl-12">
          <div className="flex flex-col md:flex-row gap-y-4 md:gap-y-0 md:gap-x-6 lg:gap-x-12 xl:gap-x-28 2xl:gap-x-36 items-center">
            <div className="relative after:content-[''] after:absolute md:after:-right-2 2xl:after:-right-12 md:after:top-0 md:after:h-[9vh] xl:after:h-[8vh] 2xl:after:h-[7vh] after:w-[0.05rem] after:bg-zinc-600">
